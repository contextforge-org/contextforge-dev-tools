...
static ASSETS: LazyLock<Vec<EmbeddedAsset>> = LazyLock::new(|| {
    let mut assets = vec![
        ...
        asset!("benchmarks/fyre/openshift.yaml"),
        asset!("benchmarks/fyre/openshift-2v2-parallel.yaml"),
        asset!("benchmarks/fyre/vertical-low-memory.yaml"),
        asset!("benchmarks/fyre/campaign.py"),
        asset!("benchmarks/fyre/openshift_campaign.py"),
        asset!("benchmarks/fyre/report.py"),
        asset!("benchmarks/fyre/README.md"),
        asset!("benchmarks/fyre/deploy/dataplane.compose.yaml"),
        asset!("benchmarks/fyre/deploy/builtin.compose.yaml"),
        asset!("benchmarks/fyre/deploy/fast-time.compose.yaml"),
        asset!("benchmarks/fyre/deploy/monitor.py"),
        asset!("benchmarks/fyre/deploy/register_builtin.py"),
        asset!("benchmarks/fyre/deploy/run_locust.py"),
        asset!("benchmarks/fyre/deploy/smoke.py"),
        asset!("benchmarks/fyre/terraform/main.tf"),
        asset!("benchmarks/fyre/terraform/.terraform.lock.hcl"),
        asset!("benchmarks/fyre/terraform/outputs.tf"),
        asset!("benchmarks/fyre/terraform/variables.tf"),
        asset!("benchmarks/fyre/terraform/versions.tf"),
